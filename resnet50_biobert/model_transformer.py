...
class TraPVQA(nn.Module):
    ...
    def __init__(self, text_encoder, image_encoder,
                 ...
                 dropout=0.1,
                 start_token_id=101,   # Neuen Parameter hinzufügen, Standard: CLS-Token (101)
                 eos_token_id=102):      # Setze EOS-Token ID entsprechend deines Tokenizers (102)
        super().__init__()
        ...
        self.start_token_id = start_token_id  # Neuer Starttoken, z. B. CLS-Token (101)
    ...
    def forward(self, images, input_ids, attention_mask, decoder_input_ids=None):
        ...
        if decoder_input_ids is not None:
            ...
            # Verwende den korrekten Starttoken
            dec_input = torch.full((batch_size, 1), self.start_token_id, dtype=torch.long, device=images.device)
            outputs = []
